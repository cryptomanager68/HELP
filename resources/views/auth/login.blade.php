...
<head>
    ...
    <title>Member Login - HELP Platform</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-50 via-teal-50 to-cyan-50 bg-pattern-dots font-sans antialiased">
    ...
    <div class="relative min-h-screen flex flex-col items-center justify-center px-4 py-12">
            ...
            <div class="relative">
                ...
                <div class="relative glass rounded-3xl p-10 shadow-2xl">
                    ...
                    <p class="text-center text-slate-600 font-medium mb-8 leading-relaxed">
                        Access your strategy dashboard
                    </p>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6">
                        ...
                        <!-- Password Input -->
                        <div>
                            <label for="password" class="block text-sm font-bold font-heading text-slate-700 mb-2">
                                Password
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        <div class="flex items-center justify-between">
                            <label class="flex items-center group cursor-pointer">
                                <input type="checkbox" name="remember" id="remember_me" class="w-4 h-4 rounded border-slate-300 text-teal-600 focus:ring-teal-500 focus:ring-offset-0 transition-all">
                                <span class="ml-2 text-sm font-semibold text-slate-600 group-hover:text-slate-900 transition-colors">Remember me</span>
                            </label>
                    ...
                    <div class="mt-4 text-center">
                        <a href="/" class="inline-flex items-center gap-2 text-sm font-semibold font-heading text-slate-500 hover:text-slate-700 transition-colors duration-300 group">
        ...
        <div class="mt-8 flex items-center gap-2 text-sm text-slate-500 animate-fadeInUp" style="animation-delay: 0.4s;">
            ...
            <span class="font-medium">Secure login • Your data is protected</span>
        </div>
